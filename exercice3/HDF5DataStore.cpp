...
void HDF5DataStore::setAttribute(const char * name, const char * val, const char * dset_name)
{
	//
	// TODO
	// Call H5LTset_attribute_string with the right arguments
...
string HDF5DataStore::getAttribute(const char * name, const char * dset_name)
{
	...
	//
	// TODO
	// Retreive the size of the string with the function H5LTget_attribute_info.
	// Retreive the value of the string with H5LTget_attribute_string.
	//
